...
{
        int ret=MSP_SUCCESS;
    const char* login_params="appid = 5b7fec54, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
    /*
    * rdn:           合成音频数字发音方式
    ...
    *
    */
    const char* session_begin_params = "voice_name = xiaoyuan, text_encoding = utf8, sample_rate = 16000, speed = 65, volume = 60, pitch = 50, rdn = 0";
